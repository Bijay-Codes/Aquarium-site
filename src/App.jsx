    ...
    <LazyMotion features={domAnimation}>
      <section className='w-full h-full relative'>
        <dialog ref={ref}
          ...
          onClick={closeDialog}>
          <div className='bg-surface-bg text-surface-fg outline z-50 outline-accent-bg/40 w-screen p-6 sm:p-10 rounded relative
          flex flex-col gap-4 max-w-130'
            onClick={(e) => e.stopPropagation()}>
            <button onClick={closeDialog} className='absolute sm:top-2 sm:right-2 top-4 right-4 sm:rounded sm:p-2 hover:text-danger/80 active:text-danger'>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8z" />
              </svg>
            </button>
            <h1 className='text-xl sm:text-2xl'>Notice</h1>
